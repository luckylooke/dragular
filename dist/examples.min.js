...
}])},{}],25:[function(e,n,t){"use strict";var o=e("./dragularModule");o.directive("dragular",["dragularService",function(e){return{restrict:"A",link:function(n,t,o){function i(e){try{return JSON.parse(e)}catch(n){return void 0}}var l=n[o.dragular]||i(o.dragular);l&&l.containersModel&&"string"==typeof l.containersModel&&(l.containersModel=n.$eval(l.containersModel)),e(t[0],l)}}}])},{"./dragularModule":26}],26:[function(e,n,t){"use strict";n.exports=angular.module("dragularModule",[]),{dragularDirective:e("./dragularDirective.js"),dragularService:e("./dragularService.js")}},{"./dragularDirective.js":25,"./dragularService.js":27}],27:[function(e,n,t){"use strict";var o=e("./dragularModule");o.factory("dragularService",["$rootScope","$timeout",function(e,n){function t(e,n,t,o){var i={mouseup:"touchend",mousedown:"touchstart",mousemove:"touchmove"},l=angular.element(e);i[t]&&l[n](i[t],o),l[n](t,o)}function o(){return!1}function i(){return!0}function l(e){function n(){var n=e;do n=n.nextSibling;while(n&&1!==n.nodeType);return n}return e.nextElementSibling||n()}function a(e){return"object"==typeof HTMLElement?e instanceof HTMLElement:e&&"object"==typeof e&&null!==e&&1===e.nodeType&&"string"==typeof e.nodeName}function r(e){var n=b[e];return n?n.lastIndex=0:b[e]=n=new RegExp("(?:^|\\s)"+e+"(?:\\s|$)","g"),n}function s(e,n){var t=e.className;t.length?r(n).test(t)||(e.className+=" "+n):e.className=n}function c(e,n){e.className=e.className.replace(r(n)," ").trim()}function d(e,n){return(" "+e.className+" ").indexOf(" "+n+" ")>-1}function p(e){return e.targetTouches&&e.targetTouches.length?e.targetTouches[0]:e.changedTouches&&e.changedTouches.length?e.changedTouches[0]:e}function m(e,n){var t=p(n),o={pageX:"clientX",pageY:"clientY"};return e in o&&!(e in t)&&o[e]in t&&(e=o[e]),t[e]}function u(e){return e.width||e.right-e.left}function v(e){return e.height||e.bottom-e.top}function g(e,n){return Array.prototype.indexOf.call(angular.element(n).children(),e)}function h(e,n){e&&(e.dispatchEvent?e.dispatchEvent(n):e.fireEvent("on"+n.eventType,n))}var f,x={},y={},b={};return function(r,p){function b(e,n,t,o){n[t]||(n[t]=[]),Array.prototype.push.apply(n[t],o),e[t]=n[t]}function I(e,n){return Array.isArray(e)?e:e.length?Array.prototype.slice.call(e,n):[e]}function w(n){e.applyAsync(function(){var e=Array.isArray(n)?n:I(n);e.forEach(function(e){We.nameSpace?angular.forEach(We.nameSpace,function(n){var t;t=Ee[n].indexOf(e),Ee[n].splice(t,1),We.containersModel&&Te[n].splice(t,1)}):Ee.splice(Ee.indexOf(e),1)})})}function B(e){return-1!==Le.containers.indexOf(e)||We.isContainer(e)}function S(e){var n;for(n in Le.containers)if(Le.containers.hasOwnProperty(n)&&-1!==Le.containers[n].indexOf(e))return!0;return!1}function M(e){var n=e?"off":"on";t(De,n,"mouseup",W),r.forEach(function(e){t(e,"on","mousedown",R)})}function k(e){var n=e?"off":"on";t(De,n,"mousemove",N)}function $(e){var n=e?"off":"on";t(De,n,"selectstart",C),t(De,n,"click",C)}function q(){M(!0),w(r),W({})}function C(e){Ne&&e.preventDefault()}function R(e){if(e=e||window.event,!(0!==e.which&&1!==e.which||e.metaKey||e.ctrlKey)){var n=e.target,t=O(n);t&&(Ne=t,k(),"mousedown"===e.type&&e.preventDefault())}}function N(e){if(k(!0),$(),T(),j(Ne),!We.direction){var n=ie.parentElement,t=n.offsetHeight,o=n.offsetWidth,i=ie.clientHeight,l=ie.clientWidth;We.direction=o/l>t/i?"horizontal":"vertical"}var a=ne(ie);ce=m("pageX",e)-a.left,de=m("pageY",e)-a.top,ue=m("clientX",e),ve=m("clientY",e),We.boundingBox&&(pe=m("pageX",e)-a.right,me=m("pageY",e)-a.bottom),e.preventDefault(),s(Be||ie,We.classes.transit),G(),f.style.left=ue-ce+"px",f.style.top=ve-de+"px",J(e)}function O(e){if(!(Le.dragging&&f||ke(e))){for(var n=e;e.parentElement&&!ke(e.parentElement);){if(We.invalid(e,n))return;if(e=e.parentElement,!e)return}var t=e.parentElement;if(t&&t&&!We.invalid(e,n)&&We.moves(e,t,n,ae,le))return{item:e,source:t}}}function D(e){var n=O(e);n&&j(n)}function j(e){if(We.containersModel){var n=r.indexOf(e.source),t=g(e.item,e.source);ye=be=t,le=We.containersModel[n],re=le,ae=le[t],We.copy&&(Se=angular.copy(ae))}return We.copy&&(Be=e.item.cloneNode(!0),We.scope&&We.scope.$emit("cloned",Be,e.item,Se,ae)),oe=e.source,ie=e.item,fe=xe=l(e.item),Le.dragging=!0,We.scope&&We.scope.$emit("drag",ie,oe),!0}function E(){return!1}function T(){if(Le.dragging){var e=Be||ie;L(e,e.parentElement)}}function A(){Ne=!1,k(!0),$(!0)}function W(e){if(A(),Le.dragging){e=e||window.event,ue=m("clientX",e),ve=m("clientY",e);var n=Be||ie,t=te(f,ue,ve),o=P(t,ue,ve);!o||We.copy!==!1&&o===oe?We.removeOnSpill?V():Y():L(n,o),$e=null,We.dragOverClasses&&Ie&&(c(Ie,we),Ie=null),We.scope&&We.scope.$emit("release",n,oe)}}function L(e,n){We.scope&&X(n)?We.scope.$emit("cancel",e,oe,Se||ae,le,re):We.scope&&We.scope.$emit("drop",e,n,oe,Se||ae,le,re),H()}function V(){if(Le.dragging){var n,t=Be||ie,o=t.parentElement;We.containersModel?e.$applyAsync(function(){re.splice(re.indexOf(Se||ae),1),H()}):o&&o.removeChild(t),We.scope&&We.scope.$emit(We.copy?"cancel":"remove",t,o,n,le,re),We.containersModel||H()}}function Y(e){if(Le.dragging){var n=arguments.length>0?e:We.revertOnSpill,t=Be||ie,o=t.parentElement;o===oe&&We.copy&&(We.containersModel?re.splice(re.indexOf(Se),1,Se):o.removeChild(Be));var i=X(o);i===!1&&We.copy===!1&&n&&(We.containersModel?(se=re,re=le,_(ye)):oe.insertBefore(t,fe)),We.scope&&(i||n)?We.scope.$emit("cancel",t,oe):We.scope&&We.scope.$emit("drop",t,o,oe),H()}}function H(){A();var e=Be||ie;K(),e&&c(e,We.classes.transit),Me&&n.cancel(Me),Le.dragging=!1,We.removeOnSpill===!0&&U(),We.scope&&(We.scope.$emit("out",e,je,oe),We.scope.$emit("dragend",e)),oe=ie=Be=fe=xe=le=null,ae=Se=ye=be=Me=je=null}function X(e,n){var t=n||(f?xe:l(ie||Be));return e===oe&&t===fe}function P(e,n,t){function o(){var o=!1;if(ke(i)){$e=i;var l=Q(i,e),a=Z(i,l,n,t),r=X(i,a);if(o=r?!0:We.accepts(ie,i,oe,a,ae,le),o&&We.containersModel)if(se=re,We.nameSpace){for(var p in Le.containers)if(Le.containers.hasOwnProperty(p)&&-1!==Le.containers[p].indexOf(i)){se=re,re=Te[p][Le.containers[p].indexOf(i)];break}}else re=Te[Le.containers.indexOf(i)]}return We.dragOverClasses&&d(i,We.classes.overActive)&&i!==Ie&&(Ie&&c(Ie,we),we=o?We.classes.overAccepts:We.classes.overDeclines,s(i,we),Ie=i),o}for(var i=e;i&&!o();)i=i.parentElement;return i}function J(n){function t(e){We.scope&&We.scope.$emit(e,ie,je,oe),We.removeOnSpill===!0&&("over"===e?F():U())}function o(){x&&t("over")}function i(){je&&t("out")}if(f){n=n||window.event,ue=m("clientX",n),ve=m("clientY",n);var a,r,s,c=ue-ce,d=ve-de;We.boundingBox&&(a=m("pageX",n),r=m("pageY",n),s=ne(We.boundingBox)),We.lockY||(!We.boundingBox||a>s.left+ce&&a<s.right+pe?f.style.left=c+"px":We.boundingBox&&(f.style.left=a<s.left+ce?ue-(a-s.left)+"px":ue-ge-(a-s.right)+"px")),We.lockX||(!We.boundingBox||r>s.top+de&&r<s.bottom+me?f.style.top=d+"px":We.boundingBox&&(f.style.top=r<s.top+de?ve-(r-s.top)+"px":ve-he-(r-s.bottom)+"px"));var p=Be||ie,u=te(f,ue,ve),v=P(u,ue,ve),x=null!==v&&v!==je;if(u!==Re&&(h(u,qe),Re&&h(Re,Ce),Re=u),(x||null===v)&&(i(),je=v,o()),v===oe&&We.copy)return void(!We.containersModel&&p.parentElement?p.parentElement.removeChild(p):We.containersModel&&-1!==se.indexOf(Se)&&e.$applyAsync(function(){se.splice(se.indexOf(Se),1)}));var y,b,I=Q(v,u);if(null!==I)y=Z(v,I,ue,ve),We.containersModel&&(b=y?g(y,v):null);else{if(We.revertOnSpill!==!0||We.copy)return void(We.copy&&null!==p.parentElement?We.containersModel?re!==le&&re.indexOf(Se||ae)&&e.$applyAsync(function(){re.splice(b,1)}):p.parentElement.removeChild(p):We.removeOnSpill&&(se=re,re=le,_(ye)));y=fe,v=oe,We.containersModel&&(b=ye,se=re,re=le)}(null===y||y!==p&&y!==l(p)&&y!==xe)&&(xe=y,We.containersModel?_(b):v.insertBefore(p,y),We.scope&&We.scope.$emit("shadow",p,v))}}function F(){var n=Be||ie;c(n,We.classes.hide),We.containersModel&&-1!==re.indexOf(n)&&e.applyAsync(function(){re.splice(re.indexOf(n),1)})}function U(){var n=Be||ie;Le.dragging&&(s(n,We.classes.hide),We.containersModel&&-1!==re.indexOf(n)&&e.applyAsync(function(){re.splice(re.indexOf(n),1)}))}function _(n){e.$applyAsync(function(){if(se===re){null===n&&(n=re.length);var e=n>be?n-1:n;re.splice(e,0,se.splice(be,1)[0]),be=e}else null===n&&(n=re.length-1),We.copy&&se===le||se.splice(be,1),We.copy&&-1!==re.indexOf(Se)||(re.splice(n,0,Se||ae),be=n)})}function z(e){if($e){var n=$e.scrollTop;$e.scrollTop+=e.deltaY,n!==$e.scrollTop&&(e.stopPropagation(),e.preventDefault())}}function G(){if(!f){var e=ie.getBoundingClientRect();f=ie.cloneNode(!0),ge=e.width,he=e.height,f.style.width=u(e)+"px",f.style.height=v(e)+"px",c(f,We.classes.transit),s(f,We.classes.mirror),We.mirrorContainer.appendChild(f),t(De,"on","mousemove",J),s(Oe,We.classes.unselectable),t(f,"on","wheel",z),We.scope&&We.scope.$emit("cloned",f,ie)}}function K(){f&&(c(Oe,We.classes.unselectable),t(De,"off","mousemove",J),t(f,"off","wheel",z),f.parentElement.removeChild(f),f=null)}function Q(e,n){for(var t=n;t!==e&&t.parentElement!==e;)t=t.parentElement;return t===De?null:t}function Z(e,n,t,o){function i(){var n,i,l,a=e.children.length;for(n=0;a>n;n++){if(i=e.children[n],l=i.getBoundingClientRect(),s&&l.left>t)return i;if(!s&&l.top>o)return i}return null}function a(){var e=n.getBoundingClientRect();return r(s?t>e.left+u(e)/2:o>e.top+v(e)/2)}function r(e){return e?l(n):n}var s="horizontal"===We.direction,c=n!==e?a():i();return c}function ee(e,n){return"undefined"!=typeof window[n]?window[n]:De.clientHeight?De[e]:Oe[e]}function ne(e){var n=e.getBoundingClientRect(),t=ee("scrollTop","pageYOffset"),o=ee("scrollLeft","pageXOffset");return{left:n.left+o,right:n.right+o,top:n.top+t,bottom:n.bottom+t}}function te(e,n,t){var o,i=e||{},l=i.className;return i.className+=" "+We.classes.hide,o=document.elementFromPoint(n,t),i.className=l,o}1!==arguments.length||Array.isArray(r)||angular.isElement(r)||r[0]||(p=r,r=[]);var oe,ie,le,ae,re,se,ce,de,pe,me,ue,ve,ge,he,fe,xe,ye,be,Ie,we,Be,Se,Me,ke,$e,qe,Ce,Re,Ne,Oe=document.body,De=document.documentElement,je=null,Ee={},Te={},Ae={mirror:"gu-mirror",hide:"gu-hide",unselectable:"gu-unselectable",transit:"gu-transit",overActive:"gu-over-active",overAccepts:"gu-over-accept",overDeclines:"gu-over-decline"},We={classes:Ae,containers:!1,moves:i,accepts:i,isContainer:o,copy:!1,delay:!1,invalid:E,revertOnSpill:!1,removeOnSpill:!1,dragOverClasses:!1,lockX:!1,lockY:!1,boundingBox:!1,containersModel:!1};a(We.boundingBox)||(We.boundingBox=null),p&&p.classes&&(angular.extend(Ae,p.classes),angular.extend(p.classes,Ae)),angular.extend(We,p),We.mirrorContainer||(We.mirrorContainer=document.body),r=We.containers||(r?I(r):[]),We.containers&&(r=I(r)),We.containersModel&&(We.containersModel=Array.isArray(We.containersModel[0])?We.containersModel:[We.containersModel]),We.nameSpace?(Array.isArray(We.nameSpace)||(We.nameSpace=[We.nameSpace]),We.nameSpace.forEach(function(e){b(Ee,x,e,r),We.containersModel&&b(Te,y,e,We.containersModel)}),ke=S):(Ee=r,ke=B,We.containersModel&&(Te=We.containersModel)),M(),document.createEvent?(qe=document.createEvent("HTMLEvents"),qe.initEvent("dragularenter",!0,!0),Ce=document.createEvent("HTMLEvents"),Ce.initEvent("dragularleave",!0,!0)):(qe=document.createEventObject(),qe.eventType="dragularenter",Ce=document.createEventObject(),Ce.eventType="dragularleave");var Le={containers:Ee,containersModel:Te,start:D,end:T,cancel:Y,remove:V,destroy:q,dragging:!1};return Le}}])},{"./dragularModule":26}]},{},[22]);

...
}])},{}],25:[function(e,n,t){"use strict";var o=e("./dragularModule");o.directive("dragular",["dragularService",function(e){return{restrict:"A",link:function(n,t,o){function i(e){try{return JSON.parse(e)}catch(n){return void 0}}var l=n[o.dragular]||i(o.dragular);l&&l.containersModel&&"string"==typeof l.containersModel&&(l.containersModel=n.$eval(l.containersModel)),e(t[0],l)}}}])},{"./dragularModule":26}],26:[function(e,n,t){"use strict";n.exports=angular.module("dragularModule",[]),{dragularDirective:e("./dragularDirective.js"),dragularService:e("./dragularService.js")}},{"./dragularDirective.js":25,"./dragularService.js":27}],27:[function(e,n,t){"use strict";var o=e("./dragularModule");o.factory("dragularService",["$rootScope","$timeout",function(e,n){function t(e,n,t,o){var i={mouseup:"touchend",mousedown:"touchstart",mousemove:"touchmove"},l=angular.element(e);"wheel"!==t&&l[n](i[t],o),l[n](t,o)}function o(){return!1}function i(){return!0}function l(e){function n(){var n=e;do n=n.nextSibling;while(n&&1!==n.nodeType);return n}return e.nextElementSibling||n()}function a(e){return"object"==typeof HTMLElement?e instanceof HTMLElement:e&&"object"==typeof e&&null!==e&&1===e.nodeType&&"string"==typeof e.nodeName}function r(e){var n=b[e];return n?n.lastIndex=0:b[e]=n=new RegExp("(?:^|\\s)"+e+"(?:\\s|$)","g"),n}function s(e,n){var t=e.className;t.length?r(n).test(t)||(e.className+=" "+n):e.className=n}function c(e,n){e.className=e.className.replace(r(n)," ").trim()}function d(e,n){return(" "+e.className+" ").indexOf(" "+n+" ")>-1}function p(e){return e.targetTouches&&e.targetTouches.length?e.targetTouches[0]:e.changedTouches&&e.changedTouches.length?e.changedTouches[0]:e}function m(e,n){var t=p(n),o={pageX:"clientX",pageY:"clientY"};return e in o&&!(e in t)&&o[e]in t&&(e=o[e]),t[e]}function u(e){return e.width||e.right-e.left}function v(e){return e.height||e.bottom-e.top}function g(e,n){return Array.prototype.indexOf.call(angular.element(n).children(),e)}function h(e,n){e.dispatchEvent?e.dispatchEvent(n):e.fireEvent("on"+n.eventType,n)}var f,x={},y={},b={};return function(r,p){function b(e,n,t,o){n[t]||(n[t]=[]),Array.prototype.push.apply(n[t],o),e[t]=n[t]}function w(e){if(Array.isArray(e))return e;if(e.length){for(var n=e.length,t=[];n;)n--,t.push(e[n]);return t}return[e]}function I(e){return function(n){var t=Array.isArray(n)?n:w(n);t.forEach(function(n){Ce.nameSpace?angular.forEach(Ce.nameSpace,function(t){var o;"add"===e?(ke[t].push(n),console.warn&&void 0):(o=ke[t].indexOf(n),ke[t].splice(o,1),Ce.containersModel&&$e[t].splice(o,1),console.warn&&void 0)}):"add"===e?(ke.push(n),console.warn&&void 0):(ke.splice(ke.indexOf(n),1),console.warn&&void 0)})}}function B(e){return-1!==Re.containers.indexOf(e)||Ce.isContainer(e)}function S(e){var n;for(n in Re.containers)if(Re.containers.hasOwnProperty(n)&&-1!==Re.containers[n].indexOf(e))return!0;return!1}function M(e){var n=e?"off":"on";t(Se,n,"mouseup",O),r.forEach(function(e){t(e,"on","mousedown",$)})}function k(){M(!0),Re.removeContainer(r),O({})}function $(e){e=e||window.event;var t=e.target;if(!(0!==e.which&&1!==e.which||e.metaKey||e.ctrlKey)&&C(t)===!0){if(!Ce.direction){var o=t.parentElement,i=o.offsetHeight,l=o.offsetWidth,a=t.clientHeight,r=t.clientWidth;Ce.direction=l/r>i/a?"horizontal":"vertical"}var s=U(G);ne=m("pageX",e)-s.left,te=m("pageY",e)-s.top,le=m("clientX",e),ae=m("clientY",e),Ce.boundingBox&&(oe=m("pageX",e)-s.right,ie=m("pageY",e)-s.bottom),"number"==typeof Ce.delay?fe=n(function(){q(e)},Ce.delay):q(e),e.preventDefault()}}function q(e){s(ge||G,Ce.classes.transit),H(),f.style.left=le-ne+"px",f.style.top=ae-te+"px",L(e)}function C(e){var n=e;if(!(Re.dragging&&f||xe(e))){for(;e.parentElement&&!xe(e.parentElement);){if(Ce.invalid(e,n))return;if(e=e.parentElement,!e)return}var t=e.parentElement;if(t&&t&&!Ce.invalid(e,n)&&Ce.moves(e,t,n,Q,K)){if(N(),Ce.containersModel){var o=r.indexOf(t),i=g(e,t);pe=me=i,K=Ce.containersModel[o],Z=K,Q=K[i],Ce.copy&&(he=angular.copy(Q))}return Ce.copy&&(ge=e.cloneNode(!0),Ce.scope&&Ce.scope.$emit("cloned",ge,e,he,Q)),z=t,G=e,ce=de=l(e),Re.dragging=!0,Ce.scope&&Ce.scope.$emit("drag",G,z),!0}}}function R(e){return"A"===e.tagName||"BUTTON"===e.tagName}function N(){if(Re.dragging){var e=ge||G;D(e,e.parentElement)}}function O(e){if(Re.dragging){e=e||window.event,le=m("clientX",e),ae=m("clientY",e);var n=ge||G,t=_(f,le,ae),o=W(t,le,ae);!o||Ce.copy!==!1&&o===z?Ce.removeOnSpill?j():E():D(n,o),ye=null,Ce.dragOverClasses&&ue&&(c(ue,ve),ue=null),Ce.scope&&Ce.scope.$emit("release",n,z)}}function D(e,n){Ce.scope&&A(n)?Ce.scope.$emit("cancel",e,z,he||Q,K,Z):Ce.scope&&Ce.scope.$emit("drop",e,n,z,he||Q,K,Z),T()}function j(){if(Re.dragging){var e,n=ge||G,t=n.parentElement;Ce.containersModel?(e=he||Q,Z.splice(Z.indexOf(e),1)):t&&t.removeChild(n),Ce.scope&&Ce.scope.$emit(Ce.copy?"cancel":"remove",n,t,e,K,Z),T()}}function E(e){if(Re.dragging){var n=arguments.length>0?e:Ce.revertOnSpill,t=ge||G,o=t.parentElement;o===z&&Ce.copy&&(Ce.containersModel?Z.splice(Z.indexOf(he),1,he):o.removeChild(ge));var i=A(o);i===!1&&Ce.copy===!1&&n&&(Ce.containersModel?(ee=Z,Z=K,V(pe)):z.insertBefore(t,ce)),Ce.scope&&(i||n)?Ce.scope.$emit("cancel",t,z):Ce.scope&&Ce.scope.$emit("drop",t,o,z),T()}}function T(){var e=ge||G;X(),e&&c(e,Ce.classes.transit),fe&&n.cancel(fe),Re.dragging=!1,Ce.scope&&(Ce.scope.$emit("dragend",e),Ce.scope.$emit("out",e,Me,z)),z=G=ge=ce=de=K=null,Q=he=pe=me=fe=Me=null}function A(e,n){var t=n||(f?de:l(G||ge));return e===z&&t===ce}function W(e,n,t){function o(){var o=!1;if(xe(i)){ye=i;var l=P(i,e),a=J(i,l,n,t),r=A(i,a);if(o=r?!0:Ce.accepts(G,i,z,a,Q,K),o&&Ce.containersModel)if(ee=Z,Ce.nameSpace){for(var p in Re.containers)if(Re.containers.hasOwnProperty(p)&&-1!==Re.containers[p].indexOf(i)){ee=Z,Z=$e[p][Re.containers[p].indexOf(i)];break}}else Z=$e[Re.containers.indexOf(i)]}return Ce.dragOverClasses&&d(i,Ce.classes.overActive)&&i!==ue&&(ue&&c(ue,ve),ve=o?Ce.classes.overAccepts:Ce.classes.overDeclines,s(i,ve),ue=i),o}for(var i=e;i&&!o();)i=i.parentElement;return i}function L(n){function t(e){Ce.scope.$emit(e,p,Me,z)}function o(){x&&t("over")}function i(){Me&&t("out")}if(f){n=n||window.event,le=m("clientX",n),ae=m("clientY",n);var a,r,s,c=le-ne,d=ae-te;Ce.boundingBox&&(a=m("pageX",n),r=m("pageY",n),s=U(Ce.boundingBox)),Ce.lockY||(!Ce.boundingBox||a>s.left+ne&&a<s.right+oe?f.style.left=c+"px":Ce.boundingBox&&(f.style.left=a<s.left+ne?le-(a-s.left)+"px":le-re-(a-s.right)+"px")),Ce.lockX||(!Ce.boundingBox||r>s.top+te&&r<s.bottom+ie?f.style.top=d+"px":Ce.boundingBox&&(f.style.top=r<s.top+te?ae-(r-s.top)+"px":ae-se-(r-s.bottom)+"px"));var p=ge||G,u=_(f,le,ae),v=W(u,le,ae),x=null!==v&&v!==Me;if(u!==Ie&&(h(u,be),Ie&&h(Ie,we),Ie=u),(x||null===v)&&(Ce.scope?(i(),Me=v,o()):Me=v),v===z&&Ce.copy)return void(!Ce.containersModel&&p.parentElement?p.parentElement.removeChild(p):Ce.containersModel&&-1!==ee.indexOf(he)&&e.$applyAsync(function(){ee.splice(ee.indexOf(he),1)}));var y,b,w=P(v,u);if(null!==w)y=J(v,w,le,ae),Ce.containersModel&&(b=y?g(y,v):null);else{if(Ce.revertOnSpill!==!0||Ce.copy)return void(!Ce.copy&&Ce.removeOnSpill!==!0||null===p.parentElement||(Ce.containersModel?e.$applyAsync(function(){Z.splice(b,1)}):p.parentElement.removeChild(p)));y=ce,v=z,Ce.containersModel&&(b=pe,ee=Z,Z=K)}(null===y||y!==p&&y!==l(p)&&y!==de)&&(de=y,Ce.containersModel?V(b):v.insertBefore(p,y),Ce.scope&&Ce.scope.$emit("shadow",p,v))}}function V(n){e.$applyAsync(function(){if(ee===Z){null===n&&(n=Z.length);var e=n>me?n-1:n;Z.splice(e,0,ee.splice(me,1)[0]),me=e}else null===n&&(n=Z.length-1),Ce.copy&&ee===K||ee.splice(me,1),Ce.copy&&-1!==Z.indexOf(he)||(Z.splice(n,0,he||Q),me=n)})}function Y(e){if(ye){var n=ye.scrollTop;ye.scrollTop+=e.deltaY,n!==ye.scrollTop&&(e.stopPropagation(),e.preventDefault())}}function H(){if(!f){var e=G.getBoundingClientRect();f=G.cloneNode(!0),re=e.width,se=e.height,f.style.width=u(e)+"px",f.style.height=v(e)+"px",c(f,Ce.classes.transit),s(f,Ce.classes.mirror),Ce.mirrorContainer.appendChild(f),t(Se,"on","mousemove",L),s(Be,Ce.classes.unselectable),t(f,"on","wheel",Y),Ce.scope&&Ce.scope.$emit("cloned",f,G)}}function X(){f&&(c(Be,Ce.classes.unselectable),t(Se,"off","mousemove",L),t(f,"off","wheel",Y),f.parentElement.removeChild(f),f=null)}function P(e,n){for(var t=n;t!==e&&t.parentElement!==e;)t=t.parentElement;return t===Se?null:t}function J(e,n,t,o){function i(){var n,i,l,a=e.children.length;for(n=0;a>n;n++){if(i=e.children[n],l=i.getBoundingClientRect(),s&&l.left>t)return i;if(!s&&l.top>o)return i}return null}function a(){var e=n.getBoundingClientRect();return r(s?t>e.left+u(e)/2:o>e.top+v(e)/2)}function r(e){return e?l(n):n}var s="horizontal"===Ce.direction,c=n!==e?a():i();return c}function F(e,n){return"undefined"!=typeof window[n]?window[n]:Se.clientHeight?Se[e]:Be[e]}function U(e){var n=e.getBoundingClientRect(),t=F("scrollTop","pageYOffset"),o=F("scrollLeft","pageXOffset");return{left:n.left+o,right:n.right+o,top:n.top+t,bottom:n.bottom+t}}function _(e,n,t){if(!n&&!t)return null;var o,i=e||{},l=i.className;return i.className+=" "+Ce.classes.hide,o=document.elementFromPoint(n,t),i.className=l,o}1!==arguments.length||Array.isArray(r)||angular.isElement(r)||r[0]||(p=r,r=[]);var z,G,K,Q,Z,ee,ne,te,oe,ie,le,ae,re,se,ce,de,pe,me,ue,ve,ge,he,fe,xe,ye,be,we,Ie,Be=document.body,Se=document.documentElement,Me=null,ke={},$e={},qe={mirror:"gu-mirror",hide:"gu-hide",unselectable:"gu-unselectable",transit:"gu-transit",overActive:"gu-over-active",overAccepts:"gu-over-accept",overDeclines:"gu-over-decline"},Ce={classes:qe,containers:!1,moves:i,accepts:i,isContainer:o,copy:!1,delay:!1,invalid:R,revertOnSpill:!1,removeOnSpill:!1,dragOverClasses:!1,lockX:!1,lockY:!1,boundingBox:!1,containersModel:!1};a(Ce.boundingBox)||(Ce.boundingBox=null),p&&p.classes&&(angular.extend(qe,p.classes),angular.extend(p.classes,qe)),angular.extend(Ce,p),Ce.delay===!0&&(Ce.delay=300),void 0===Ce.mirrorContainer&&(Ce.mirrorContainer=document.body),r=Ce.containers||(r?w(r):[]),Ce.containers&&(r=w(r)),Ce.containersModel&&(Ce.containersModel=Array.isArray(Ce.containersModel[0])?Ce.containersModel:[Ce.containersModel]),Ce.nameSpace?(Array.isArray(Ce.nameSpace)||(Ce.nameSpace=[Ce.nameSpace]),Ce.nameSpace.forEach(function(e){b(ke,x,e,r),Ce.containersModel&&b($e,y,e,Ce.containersModel)}),xe=S):(ke=r,xe=B,Ce.containersModel&&($e=Ce.containersModel)),M(),document.createEvent?(be=document.createEvent("HTMLEvents"),be.initEvent("dragularenter",!0,!0),we=document.createEvent("HTMLEvents"),we.initEvent("dragularleave",!0,!0)):(be=document.createEventObject(),be.eventType="dragularenter",we=document.createEventObject(),we.eventType="dragularleave");var Re={addContainer:I("add"),removeContainer:I("remove"),containers:ke,containersModel:$e,start:C,end:N,cancel:E,remove:j,destroy:k,dragging:!1};return Re}}])},{"./dragularModule":26}]},{},[22]);

...
}])},{}],26:[function(e,n,t){"use strict";var i=e("./dragularModule");i.directive("dragular",["dragularService",function(e){return{restrict:"A",link:function(n,t,i){function o(e){try{return JSON.parse(e)}catch(n){return void 0}}var l=n[i.dragular]||o(i.dragular);l&&l.containersModel&&"string"==typeof l.containersModel&&(l.containersModel=n.$eval(l.containersModel)),e(t[0],l)}}}])},{"./dragularModule":27}],27:[function(e,n,t){"use strict";n.exports=angular.module("dragularModule",[]),{dragularDirective:e("./dragularDirective.js"),dragularService:e("./dragularService.js")}},{"./dragularDirective.js":26,"./dragularService.js":28}],28:[function(e,n,t){"use strict";var i=e("./dragularModule");i.factory("dragularService",["$rootScope",function(e){function n(e,n,t,i){var o={mouseup:"touchend",mousedown:"touchstart",mousemove:"touchmove"},l=angular.element(e);o[t]&&l[n](o[t],i),l[n](t,i)}function t(){return!1}function i(){return!0}function o(e){function n(){var n=e;do n=n.nextSibling;while(n&&1!==n.nodeType);return n}return e.nextElementSibling||n()}function l(e){return"object"==typeof HTMLElement?e instanceof HTMLElement:e&&"object"==typeof e&&null!==e&&1===e.nodeType&&"string"==typeof e.nodeName}function a(e){var n=y[e];return n?n.lastIndex=0:y[e]=n=new RegExp("(?:^|\\s)"+e+"(?:\\s|$)","g"),n}function r(e,n){var t=e.className;t.length?a(n).test(t)||(e.className+=" "+n):e.className=n}function s(e,n){e.className=e.className.replace(a(n)," ").trim()}function c(e,n){return(" "+e.className+" ").indexOf(" "+n+" ")>-1}function d(e){return e.targetTouches&&e.targetTouches.length?e.targetTouches[0]:e.changedTouches&&e.changedTouches.length?e.changedTouches[0]:e}function p(e,n){var t=d(n),i={pageX:"clientX",pageY:"clientY"};return e in i&&!(e in t)&&i[e]in t&&(e=i[e]),t[e]}function m(e){return e.width||e.right-e.left}function v(e){return e.height||e.bottom-e.top}function u(e,n){return Array.prototype.indexOf.call(angular.element(n).children(),e)}function g(e,n){e&&(e.dispatchEvent?e.dispatchEvent(n):e.fireEvent("on"+n.eventType,n))}var h,f={},x={},y={};return function(a,d){function y(e,n,t,i){n[t]||(n[t]=[]),Array.prototype.push.apply(n[t],i),e[t]=n[t]}function b(e,n){return Array.isArray(e)?e:e.length?Array.prototype.slice.call(e,n):[e]}function I(n){e.applyAsync(function(){var e=Array.isArray(n)?n:b(n);e.forEach(function(e){Ne.nameSpace?angular.forEach(Ne.nameSpace,function(n){var t;t=ke[n].indexOf(e),ke[n].splice(t,1),Ne.containersModel&&Re[n].splice(t,1)}):ke.splice(ke.indexOf(e),1)})})}function w(e){return-1!==Oe.containers.indexOf(e)||Ne.isContainer(e)}function B(e){var n;for(n in Oe.containers)if(Oe.containers.hasOwnProperty(n)&&-1!==Oe.containers[n].indexOf(e))return!0;return!1}function S(e){var t=e?"off":"on";n(qe,t,"mouseup",A),a.forEach(function(e){n(e,"on","mousedown",R)})}function M(e){var t=e?"off":"on";n(qe,t,"mousemove",C)}function q(e){var t=e?"off":"on";n(qe,t,"selectstart",k),n(qe,t,"click",k)}function $(){S(!0),I(a),A({})}function k(e){Se&&e.preventDefault()}function R(e){if(e=e||window.event,!(0!==e.which&&1!==e.which||e.metaKey||e.ctrlKey)){var n=e.target,t=N(n);t&&(Se=t,M(),"mousedown"===e.type&&e.preventDefault())}}function C(e){if(M(!0),q(),E(),D(Se),!Ne.direction){var n=te.parentElement,t=n.offsetHeight,i=n.offsetWidth,o=te.clientHeight,l=te.clientWidth;Ne.direction=i/l>t/o?"horizontal":"vertical"}var a=Z(te);oe=p("pageX",e)-a.left,le=p("pageY",e)-a.top,se=p("clientX",e),ce=p("clientY",e),Ne.boundingBox&&(ae=p("pageX",e)-a.right,re=p("pageY",e)-a.bottom),e.preventDefault(),r(xe||te,Ne.classes.transit),_(),h.style.left=se-oe+"px",h.style.top=ce-le+"px",P(e)}function N(e){if(!(Oe.dragging&&h||ye(e))){for(var n=e;e.parentElement&&!ye(e.parentElement);){if(Ne.invalid(e,n))return;if(e=e.parentElement,!e)return}var t=e.parentElement;if(t&&t&&!Ne.invalid(e,n)&&Ne.moves(e,t,n,ie))return{item:e,source:t}}}function O(e){var n=N(e);n&&D(n)}function D(e){if(Ne.copy&&(xe=e.item.cloneNode(!0),Ne.scope&&Ne.scope.$emit("cloned",xe,e.item)),ne=e.source,te=e.item,me=ve=o(e.item),Ne.containersModel){var n=a.indexOf(e.source);ie=Ne.containersModel[n],ue=u(e.item,e.source)}return Oe.dragging=!0,Ne.scope&&Ne.scope.$emit("drag",te,ne),!0}function j(){return!1}function E(){if(Oe.dragging){var e=xe||te;W(e,e.parentElement)}}function T(){Se=!1,M(!0),q(!0)}function A(e){if(T(),Oe.dragging){e=e||window.event,se=p("clientX",e),ce=p("clientY",e);var n=xe||te,t=ee(h,se,ce),i=X(t,se,ce);!i||Ne.copy!==!1&&i===ne?Ne.removeOnSpill?V():L():W(n,i),be=null,Ne.dragOverClasses&&he&&(s(he,fe),he=null),Ne.scope&&Ne.scope.$emit("release",n,ne)}}function W(n,t){if(Ne.scope&&H(t)?Ne.scope.$emit("cancel",n,ne,ie):Ne.scope&&Ne.scope.$emit("drop",n,t,ne,ie),Ne.containersModel&&!H(t)){var i=xe||te,o=u(i,t);e.$applyAsync(function(){if(t===ne)ie.splice(o,0,ie.splice(ue,1)[0]);else{var e,n=Ne.copy?angular.copy(ie[ue]):ie[ue];if(Ne.nameSpace){for(var l in Oe.containers)if(Oe.containers.hasOwnProperty(l)&&-1!==Oe.containers[l].indexOf(t)){e=Re[l][Oe.containers[l].indexOf(t)];break}}else e=Re[Oe.containers.indexOf(t)];Ne.copy||ie.splice(ue,1),e.splice(o,0,n),t.removeChild(i)}var a=xe||te;a.parentElement&&a.parentElement.removeChild(a),Y()})}else Y()}function V(){if(Oe.dragging){var n=xe||te,t=n.parentElement,i=ie&&ie[ue];t&&t.removeChild(n),Ne.containersModel&&e.$applyAsync(function(){ie.splice(ue,1),Y()}),Ne.scope&&Ne.scope.$emit(Ne.copy?"cancel":"remove",n,t,i,ie),Ne.containersModel||Y()}}function L(e){if(Oe.dragging){var n=arguments.length>0?e:Ne.revertOnSpill,t=xe||te,i=t.parentElement,o=H(i);o===!1&&Ne.copy===!1&&n&&ne.insertBefore(t,me),!Ne.containersModel||Ne.copy||n?Ne.scope&&(o||n?Ne.scope.$emit("cancel",t,ne):Ne.scope.$emit("drop",t,i,ne)):W(t,i),(!Ne.containersModel||Ne.copy||n||o)&&Y()}}function Y(){T();var e=xe||te;z(),e&&s(e,Ne.classes.transit),Oe.dragging=!1,Ne.removeOnSpill===!0&&F(),Ne.scope&&(Ne.scope.$emit("out",e,$e,ne),Ne.scope.$emit("dragend",e)),ne=te=xe=me=ve=ie=null,ue=ge=$e=null}function H(e,n){var t=n||(h?ve:o(te||xe));return e===ne&&t===me}function X(e,n,t){function i(){var i=!1;if(ye(o)){var l=G(o,e),a=K(o,l,n,t),d=H(o,a);i=d?!0:Ne.accepts(te,o,ne,a,ie),be!==o&&(be=o)}return Ne.dragOverClasses&&c(o,Ne.classes.overActive)&&o!==he&&(he&&s(he,fe),fe=i?Ne.classes.overAccepts:Ne.classes.overDeclines,r(o,fe),he=o),i}for(var o=e;o&&!i();)o=o.parentElement;return o}function P(e){function n(e){Ne.scope&&Ne.scope.$emit(e,te,$e,ne),Ne.removeOnSpill===!0&&("over"===e?J():F())}function t(){u&&n("over")}function i(){$e&&n("out")}if(h){e=e||window.event,se=p("clientX",e),ce=p("clientY",e);var l,a,r,s=se-oe,c=ce-le;Ne.boundingBox&&(l=p("pageX",e),a=p("pageY",e),r=Z(Ne.boundingBox)),Ne.lockY||(!Ne.boundingBox||l>r.left+oe&&l<r.right+ae?h.style.left=s+"px":Ne.boundingBox&&(h.style.left=l<r.left+oe?se-(l-r.left)+"px":se-de-(l-r.right)+"px")),Ne.lockX||(!Ne.boundingBox||a>r.top+le&&a<r.bottom+re?h.style.top=c+"px":Ne.boundingBox&&(h.style.top=a<r.top+le?ce-(a-r.top)+"px":ce-pe-(a-r.bottom)+"px"));var d=xe||te,m=ee(h,se,ce),v=X(m,se,ce),u=null!==v&&v!==$e;if(m!==Be&&(g(m,Ie),Be&&g(Be,we),Be=m),(u||null===v)&&(i(),$e=v,t()),v===ne&&Ne.copy)return void(d.parentElement&&d.parentElement.removeChild(d));var f,x=G(v,m);if(null!==x)f=K(v,x,se,ce);else{if(Ne.revertOnSpill!==!0||Ne.copy)return void(Ne.copy&&null!==d.parentElement&&d.parentElement.removeChild(d));f=me,v=ne}(null===f||f!==d&&f!==o(d)&&f!==ve)&&(ve=f,v.insertBefore(d,f),Ne.scope&&Ne.scope.$emit("shadow",d,v))}}function J(){var e=xe||te;s(e,Ne.classes.hide)}function F(){var e=xe||te;Oe.dragging&&r(e,Ne.classes.hide)}function U(e){if(be){var n=be.scrollTop;be.scrollTop+=e.deltaY,n!==be.scrollTop&&(e.stopPropagation(),e.preventDefault())}}function _(){if(!h){var e=te.getBoundingClientRect();h=te.cloneNode(!0),de=e.width,pe=e.height,h.style.width=m(e)+"px",h.style.height=v(e)+"px",s(h,Ne.classes.transit),r(h,Ne.classes.mirror),Ne.mirrorContainer.appendChild(h),n(qe,"on","mousemove",P),r(Me,Ne.classes.unselectable),n(h,"on","wheel",U),Ne.scope&&Ne.scope.$emit("cloned",h,te)}}function z(){h&&(s(Me,Ne.classes.unselectable),n(qe,"off","mousemove",P),n(h,"off","wheel",U),h.parentElement.removeChild(h),h=null)}function G(e,n){for(var t=n;t!==e&&t.parentElement!==e;)t=t.parentElement;return t===qe?null:t}function K(e,n,t,i){function l(){var n,o,l,a=e.children.length;for(n=0;a>n;n++){if(o=e.children[n],l=o.getBoundingClientRect(),s&&l.left>t)return o;if(!s&&l.top>i)return o}return null}function a(){var e=n.getBoundingClientRect();return r(s?t>e.left+m(e)/2:i>e.top+v(e)/2)}function r(e){return e?o(n):n}var s="horizontal"===Ne.direction,c=n!==e?a():l();return c}function Q(e,n){return"undefined"!=typeof window[n]?window[n]:qe.clientHeight?qe[e]:Me[e]}function Z(e){var n=e.getBoundingClientRect(),t=Q("scrollTop","pageYOffset"),i=Q("scrollLeft","pageXOffset");return{left:n.left+i,right:n.right+i,top:n.top+t,bottom:n.bottom+t}}function ee(e,n,t){var i,o=e||{},l=o.className;return o.className+=" "+Ne.classes.hide,i=document.elementFromPoint(n,t),o.className=l,i}1!==arguments.length||Array.isArray(a)||angular.isElement(a)||a[0]||(d=a,a=[]);var ne,te,ie,oe,le,ae,re,se,ce,de,pe,me,ve,ue,ge,he,fe,xe,ye,be,Ie,we,Be,Se,Me=document.body,qe=document.documentElement,$e=null,ke={},Re={},Ce={mirror:"gu-mirror",hide:"gu-hide",unselectable:"gu-unselectable",transit:"gu-transit",overActive:"gu-over-active",overAccepts:"gu-over-accept",overDeclines:"gu-over-decline"},Ne={classes:Ce,containers:!1,moves:i,accepts:i,isContainer:t,copy:!1,delay:!1,invalid:j,revertOnSpill:!1,removeOnSpill:!1,dragOverClasses:!1,lockX:!1,lockY:!1,boundingBox:!1,containersModel:!1};l(Ne.boundingBox)||(Ne.boundingBox=null),d&&d.classes&&(angular.extend(Ce,d.classes),angular.extend(d.classes,Ce)),angular.extend(Ne,d),Ne.mirrorContainer||(Ne.mirrorContainer=document.body),a=Ne.containers||(a?b(a):[]),Ne.containers&&(a=b(a)),Ne.containersModel&&(Ne.containersModel=Array.isArray(Ne.containersModel[0])?Ne.containersModel:[Ne.containersModel]),Ne.nameSpace?(Array.isArray(Ne.nameSpace)||(Ne.nameSpace=[Ne.nameSpace]),Ne.nameSpace.forEach(function(e){y(ke,f,e,a),Ne.containersModel&&y(Re,x,e,Ne.containersModel)}),ye=B):(ke=a,ye=w,Ne.containersModel&&(Re=Ne.containersModel)),S(),document.createEvent?(Ie=document.createEvent("HTMLEvents"),Ie.initEvent("dragularenter",!0,!0),we=document.createEvent("HTMLEvents"),we.initEvent("dragularleave",!0,!0)):(Ie=document.createEventObject(),Ie.eventType="dragularenter",we=document.createEventObject(),we.eventType="dragularleave");var Oe={containers:ke,containersModel:Re,start:O,end:E,cancel:L,remove:V,destroy:$,dragging:!1};return Oe}}])},{"./dragularModule":27}]},{},[23]);

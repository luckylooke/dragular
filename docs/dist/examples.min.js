...
}])},{}],26:[function(e,n,t){"use strict";var o=e("./dragularModule");o.directive("dragular",["dragularService",function(e){return{restrict:"A",link:function(n,t,o){function i(e){try{return JSON.parse(e)}catch(n){return void 0}}var l=n[o.dragular]||i(o.dragular);l&&l.containersModel&&"string"==typeof l.containersModel&&(l.containersModel=n.$eval(l.containersModel)),e(t[0],l)}}}])},{"./dragularModule":27}],27:[function(e,n,t){"use strict";n.exports=angular.module("dragularModule",[]),{dragularDirective:e("./dragularDirective.js"),dragularService:e("./dragularService.js")}},{"./dragularDirective.js":26,"./dragularService.js":28}],28:[function(e,n,t){"use strict";var o=e("./dragularModule");o.factory("dragularService",["$rootScope",function(e){function n(e,n,t,o){var i={mouseup:"touchend",mousedown:"touchstart",mousemove:"touchmove"},l=angular.element(e);i[t]&&l[n](i[t],o),l[n](t,o)}function t(){return!1}function o(){return!0}function i(e){function n(){var n=e;do n=n.nextSibling;while(n&&1!==n.nodeType);return n}return e.nextElementSibling||n()}function l(e){return"object"==typeof HTMLElement?e instanceof HTMLElement:e&&"object"==typeof e&&null!==e&&1===e.nodeType&&"string"==typeof e.nodeName}function a(e){var n=y[e];return n?n.lastIndex=0:y[e]=n=new RegExp("(?:^|\\s)"+e+"(?:\\s|$)","g"),n}function r(e,n){var t=e.className;t.length?a(n).test(t)||(e.className+=" "+n):e.className=n}function s(e,n){e.className=e.className.replace(a(n)," ").trim()}function c(e,n){return(" "+e.className+" ").indexOf(" "+n+" ")>-1}function d(e){return e.targetTouches&&e.targetTouches.length?e.targetTouches[0]:e.changedTouches&&e.changedTouches.length?e.changedTouches[0]:e}function p(e,n){var t=d(n),o={pageX:"clientX",pageY:"clientY"};return e in o&&!(e in t)&&o[e]in t&&(e=o[e]),t[e]}function m(e){return e.width||e.right-e.left}function v(e){return e.height||e.bottom-e.top}function u(e,n){return Array.prototype.indexOf.call(angular.element(n).children(),e)}function g(e,n){e&&(e.dispatchEvent?e.dispatchEvent(n):e.fireEvent("on"+n.eventType,n))}var h,f={},x={},y={};return function(a,d){function y(e,n,t,o){n[t]||(n[t]=[]),Array.prototype.push.apply(n[t],o),e[t]=n[t]}function b(e,n){return Array.isArray(e)?e:e.length?Array.prototype.slice.call(e,n):[e]}function I(n){e.applyAsync(function(){var e=Array.isArray(n)?n:b(n);e.forEach(function(e){Ae.nameSpace?angular.forEach(Ae.nameSpace,function(n){var t;t=je[n].indexOf(e),je[n].splice(t,1),Ae.containersModel&&Ee[n].splice(t,1)}):je.splice(je.indexOf(e),1)})})}function w(e){return-1!==We.containers.indexOf(e)||Ae.isContainer(e)}function B(e){var n;for(n in We.containers)if(We.containers.hasOwnProperty(n)&&-1!==We.containers[n].indexOf(e))return!0;return!1}function S(e){var t=e?"off":"on";n(Oe,t,"mouseup",A),a.forEach(function(e){n(e,"on","mousedown",R)})}function M(e){var t=e?"off":"on";n(Oe,t,"mousemove",C)}function q(e){var t=e?"off":"on";n(Oe,t,"selectstart",k),n(Oe,t,"click",k)}function $(){S(!0),I(a),A({})}function k(e){Re&&e.preventDefault()}function R(e){if(e=e||window.event,!(0!==e.which&&1!==e.which||e.metaKey||e.ctrlKey)){var n=e.target,t=N(n);t&&(Re=t,M(),"mousedown"===e.type&&e.preventDefault())}}function C(e){if(M(!0),q(),E(),D(Re),!Ae.direction){var n=oe.parentElement,t=n.offsetHeight,o=n.offsetWidth,i=oe.clientHeight,l=oe.clientWidth;Ae.direction=o/l>t/i?"horizontal":"vertical"}var a=ee(oe);se=p("pageX",e)-a.left,ce=p("pageY",e)-a.top,me=p("clientX",e),ve=p("clientY",e),Ae.boundingBox&&(de=p("pageX",e)-a.right,pe=p("pageY",e)-a.bottom),e.preventDefault(),r(we||oe,Ae.classes.transit),z(),h.style.left=me-se+"px",h.style.top=ve-ce+"px",P(e)}function N(e){if(!(We.dragging&&h||Se(e))){for(var n=e;e.parentElement&&!Se(e.parentElement);){if(Ae.invalid(e,n))return;if(e=e.parentElement,!e)return}var t=e.parentElement;if(t&&t&&!Ae.invalid(e,n)&&Ae.moves(e,t,n,le,ie))return{item:e,source:t}}}function O(e){var n=N(e);n&&D(n)}function D(e){if(Ae.containersModel){var n=a.indexOf(e.source),t=u(e.item,e.source);xe=ye=t,ie=Ae.containersModel[n],ae=ie,le=ie[t],Ae.copy&&(Be=angular.copy(le))}return Ae.copy&&(we=e.item.cloneNode(!0),Ae.scope&&Ae.scope.$emit("cloned",we,e.item,Be,le)),te=e.source,oe=e.item,he=fe=i(e.item),We.dragging=!0,Ae.scope&&Ae.scope.$emit("drag",oe,te),!0}function j(){return!1}function E(){if(We.dragging){var e=we||oe;W(e,e.parentElement)}}function T(){Re=!1,M(!0),q(!0)}function A(e){if(T(),We.dragging){e=e||window.event,me=p("clientX",e),ve=p("clientY",e);var n=we||oe,t=ne(h,me,ve),o=X(t,me,ve);!o||Ae.copy!==!1&&o===te?Ae.removeOnSpill?V():L():(W(n,o),Ae.containersModel&&U(Ce,!0)),Me=null,Ae.dragOverClasses&&be&&(s(be,Ie),be=null),Ae.scope&&Ae.scope.$emit("release",n,te)}}function W(e,n){Ae.scope&&H(n)?Ae.scope.$emit("cancel",e,te,Be||le,ie,ae):Ae.scope&&Ae.scope.$emit("drop",e,n,te,Be||le,ie,ae),Ae.containersModel||Y()}function V(){if(We.dragging){var n=we||oe,t=n.parentElement,o=ie&&ie[xe];t&&t.removeChild(n),Ae.containersModel&&e.$applyAsync(function(){ie.splice(xe,1),Y()}),Ae.scope&&Ae.scope.$emit(Ae.copy?"cancel":"remove",n,t,o,ie,ae),Ae.containersModel||Y()}}function L(e){if(We.dragging){var n=arguments.length>0?e:Ae.revertOnSpill,t=we||oe,o=t.parentElement;o===te&&Ae.copy&&o.removeChild(we);var i=H(o);i===!1&&Ae.copy===!1&&n&&(Ae.containersModel?(re=ae,ae=ie,U(xe,!0)):te.insertBefore(t,he)),Ae.scope&&(i||n)?Ae.scope.$emit("cancel",t,te):Ae.scope&&Ae.scope.$emit("drop",t,o,te),(!Ae.containersModel||Ae.copy)&&Y()}}function Y(){T();var e=we||oe;G(),e&&s(e,Ae.classes.transit),We.dragging=!1,Ae.removeOnSpill===!0&&F(),Ae.scope&&(Ae.scope.$emit("out",e,De,te),Ae.scope.$emit("dragend",e)),te=oe=we=he=fe=ie=null,le=Be=xe=ye=De=null}function H(e,n){var t=n||(h?fe:i(oe||we));return e===te&&t===he}function X(e,n,t){function o(){var o=!1;if(Se(i)){var l=K(i,e),a=Q(i,l,n,t),d=H(i,a);if(o=d?!0:Ae.accepts(oe,i,te,a,le,ie),Me!==i&&(Me=i,o&&Ae.containersModel))if(Ae.nameSpace){for(var p in We.containers)if(We.containers.hasOwnProperty(p)&&-1!==We.containers[p].indexOf(i)){re=ae,ae=Ee[p][We.containers[p].indexOf(i)];break}}else re=ae,ae=Ee[We.containers.indexOf(i)]}return Ae.dragOverClasses&&c(i,Ae.classes.overActive)&&i!==be&&(be&&s(be,Ie),Ie=o?Ae.classes.overAccepts:Ae.classes.overDeclines,r(i,Ie),be=i),o}for(var i=e;i&&!o();)i=i.parentElement;return i}function P(e){function n(e){Ae.scope&&Ae.scope.$emit(e,oe,De,te),Ae.removeOnSpill===!0&&("over"===e?J():F())}function t(){f&&n("over")}function o(){De&&n("out")}if(h){e=e||window.event,me=p("clientX",e),ve=p("clientY",e);var l,a,r,s=me-se,c=ve-ce;Ae.boundingBox&&(l=p("pageX",e),a=p("pageY",e),r=ee(Ae.boundingBox)),Ae.lockY||(!Ae.boundingBox||l>r.left+se&&l<r.right+de?h.style.left=s+"px":Ae.boundingBox&&(h.style.left=l<r.left+se?me-(l-r.left)+"px":me-ue-(l-r.right)+"px")),Ae.lockX||(!Ae.boundingBox||a>r.top+ce&&a<r.bottom+pe?h.style.top=c+"px":Ae.boundingBox&&(h.style.top=a<r.top+ce?ve-(a-r.top)+"px":ve-ge-(a-r.bottom)+"px"));var d=we||oe,m=ne(h,me,ve),v=X(m,me,ve),f=null!==v&&v!==De;if(m!==ke&&(g(m,qe),ke&&g(ke,$e),ke=m),(f||null===v)&&(o(),De=v,t()),v===te&&Ae.copy)return void(d.parentElement&&d.parentElement.removeChild(d));var x,y=K(v,m);if(null!==y)x=Q(v,y,me,ve),Ae.containersModel&&(Ce=x?u(we||oe,v):null);else{if(Ae.revertOnSpill!==!0||Ae.copy)return void(Ae.copy&&null!==d.parentElement&&d.parentElement.removeChild(d));x=he,v=te,Ae.containersModel&&(Ce=xe,re=ae,ae=ie)}(null===x||x!==d&&x!==i(d)&&x!==fe)&&(fe=x,v.insertBefore(d,x),Ae.scope&&Ae.scope.$emit("shadow",d,v))}}function J(){var e=we||oe;s(e,Ae.classes.hide)}function F(){var e=we||oe;We.dragging&&r(e,Ae.classes.hide)}function U(n,t){e.$applyAsync(function(){if(null===n&&(n=ae.length),re===ae?ae.splice(n,0,re.splice(ye,1)[0]):(Ae.copy&&re===ie||re.splice(ye,1),Ae.copy&&-1!==ae.indexOf(Be)||ae.splice(n,0,Be||le)),ye=n,t){var e=we||oe;e.parentElement&&e.parentElement.removeChild(e),Y()}})}function _(e){if(Me){var n=Me.scrollTop;Me.scrollTop+=e.deltaY,n!==Me.scrollTop&&(e.stopPropagation(),e.preventDefault())}}function z(){if(!h){var e=oe.getBoundingClientRect();h=oe.cloneNode(!0),ue=e.width,ge=e.height,h.style.width=m(e)+"px",h.style.height=v(e)+"px",s(h,Ae.classes.transit),r(h,Ae.classes.mirror),Ae.mirrorContainer.appendChild(h),n(Oe,"on","mousemove",P),r(Ne,Ae.classes.unselectable),n(h,"on","wheel",_),Ae.scope&&Ae.scope.$emit("cloned",h,oe)}}function G(){h&&(s(Ne,Ae.classes.unselectable),n(Oe,"off","mousemove",P),n(h,"off","wheel",_),h.parentElement.removeChild(h),h=null)}function K(e,n){for(var t=n;t!==e&&t.parentElement!==e;)t=t.parentElement;return t===Oe?null:t}function Q(e,n,t,o){function l(){var n,i,l,a=e.children.length;for(n=0;a>n;n++){if(i=e.children[n],l=i.getBoundingClientRect(),s&&l.left>t)return i;if(!s&&l.top>o)return i}return null}function a(){var e=n.getBoundingClientRect();return r(s?t>e.left+m(e)/2:o>e.top+v(e)/2)}function r(e){return e?i(n):n}var s="horizontal"===Ae.direction,c=n!==e?a():l();return c}function Z(e,n){return"undefined"!=typeof window[n]?window[n]:Oe.clientHeight?Oe[e]:Ne[e]}function ee(e){var n=e.getBoundingClientRect(),t=Z("scrollTop","pageYOffset"),o=Z("scrollLeft","pageXOffset");return{left:n.left+o,right:n.right+o,top:n.top+t,bottom:n.bottom+t}}function ne(e,n,t){var o,i=e||{},l=i.className;return i.className+=" "+Ae.classes.hide,o=document.elementFromPoint(n,t),i.className=l,o}1!==arguments.length||Array.isArray(a)||angular.isElement(a)||a[0]||(d=a,a=[]);var te,oe,ie,le,ae,re,se,ce,de,pe,me,ve,ue,ge,he,fe,xe,ye,be,Ie,we,Be,Se,Me,qe,$e,ke,Re,Ce,Ne=document.body,Oe=document.documentElement,De=null,je={},Ee={},Te={mirror:"gu-mirror",hide:"gu-hide",unselectable:"gu-unselectable",transit:"gu-transit",overActive:"gu-over-active",overAccepts:"gu-over-accept",overDeclines:"gu-over-decline"},Ae={classes:Te,containers:!1,moves:o,accepts:o,isContainer:t,copy:!1,delay:!1,invalid:j,revertOnSpill:!1,removeOnSpill:!1,dragOverClasses:!1,lockX:!1,lockY:!1,boundingBox:!1,containersModel:!1};l(Ae.boundingBox)||(Ae.boundingBox=null),d&&d.classes&&(angular.extend(Te,d.classes),angular.extend(d.classes,Te)),angular.extend(Ae,d),Ae.mirrorContainer||(Ae.mirrorContainer=document.body),a=Ae.containers||(a?b(a):[]),Ae.containers&&(a=b(a)),Ae.containersModel&&(Ae.containersModel=Array.isArray(Ae.containersModel[0])?Ae.containersModel:[Ae.containersModel]),Ae.nameSpace?(Array.isArray(Ae.nameSpace)||(Ae.nameSpace=[Ae.nameSpace]),Ae.nameSpace.forEach(function(e){y(je,f,e,a),Ae.containersModel&&y(Ee,x,e,Ae.containersModel)}),Se=B):(je=a,Se=w,Ae.containersModel&&(Ee=Ae.containersModel)),S(),document.createEvent?(qe=document.createEvent("HTMLEvents"),qe.initEvent("dragularenter",!0,!0),$e=document.createEvent("HTMLEvents"),$e.initEvent("dragularleave",!0,!0)):(qe=document.createEventObject(),qe.eventType="dragularenter",$e=document.createEventObject(),$e.eventType="dragularleave");var We={containers:je,containersModel:Ee,start:O,end:E,cancel:L,remove:V,destroy:$,dragging:!1};return We}}])},{"./dragularModule":27}]},{},[23]);
